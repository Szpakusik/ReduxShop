                            ...
                            <div className={`row w-100 mx-auto ${myAccount.addresses}`}>
                                ...
                                <div className="mt-2 text-center w-100">
                                    ...
                                    <div className={`${orderView.contactDetails} px-1 mt-2 bg-white border py-3 flex-wrap`}>
                                        ...
                                        <input onChange={ e => getLastName(e.target.value)} value={lastName} className={`text-success mt-2 ml-lg-2 ${orderView.addressInfo}`} placeholder={`Nazwisko`}></input>
                                        ...
                                        <input onChange={ e => getPhone(e.target.value)} value={phone} className={`text-success mt-2 ml-lg-2 ${orderView.addressInfo}`} placeholder={`Telefon`}></input>
                                    </div>
                                </div>       
